...
const NodeCheckbox = ({disabled, node, handleCheck}: NodeCheckboxProps) => {
...
export const NodeList = ({selectedNode, onNodeSelect}: NodeListProps) => {
...
const getDisabledNodes = (selectedNode?: NodeStruct): NodeType[] => {
