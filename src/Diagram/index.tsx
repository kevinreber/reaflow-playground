...
const Controls = ({onZoomIn, onZoomOut, onZoomReset}: ControlsProps) => (
...
const Control = ({title, icon, onClick}: ControlProps) => (
...
const canvasAction = (instance: CanvasRef, type: CanvasAction) => {
  switch (type) {
    case 'zoomIn':
